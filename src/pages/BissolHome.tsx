import StatusBar from '../components/bissolhome/StatusBar'
import Header from '../components/bissolhome/Header'
import BottomNav from '../components/layout/BottomNav'
import BottomPanel from '../components/bissolhome/BottomPanel'
...
import TodayWeatherCardSection from '../components/weather/TodayWeatherCardSection'
...
function BissolHome() {
    return (
        <div className="container-fluid min-vh-100 d-flex flex-column py-3">
            ...
            <main className="d-flex flex-column flex-grow-1 justify-content-end gap-3">
                <div className="d-flex justify-content-center">
                    <TodayWeatherCardSection
